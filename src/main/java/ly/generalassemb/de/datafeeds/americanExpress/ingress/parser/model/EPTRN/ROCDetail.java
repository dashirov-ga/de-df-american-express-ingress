...
@JsonPropertyOrder({ "TLRR_AMEX_PAYEE_NUMBER", "TLRR_AMEX_SE_NUMBER", "TLRR_SE_UNIT_NUMBER", "TLRR_PAYMENT_YEAR",
                     "TLRR_PAYMENT_NUMBER", "TLRR_RECORD_TYPE", "TLRR_DETAIL_RECORD_TYPE",
                     "TLRR_SE_BUSINESS_DATE", "TLRR_AMEX_PROCESS_DATE", "TLRR_SOC_INVOICE_NUMBER",
                     "TLRR_SOC_AMOUNT", "TLRR_ROC_AMOUNT", "TLRR_CM_NUMBER", "TLRR_CM_REF_NO", "TLRR_TRAN_DATE",
                     "TLRR_SE_REF_POA", "NON_COMPLIANT_INDICATOR", "NON_COMPLIANT_ERROR_CODE_1",
                     "NON_COMPLIANT_ERROR_CODE_2", "NON_COMPLIANT_ERROR_CODE_3", "NON_COMPLIANT_ERROR_CODE_4",
                     "NON_SWIPED_INDICATOR", "TLRR_CM_NUMBER_EXD"

})
public class ROCDetail implements AmexFeedLineParserOutput {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(getAmexPayeeNumber(), rocDetail.getAmexPayeeNumber())
                ...
                .append(getCardMemberNumberExtended(), rocDetail.getCardMemberNumberExtended()).isEquals();
    }

    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(getAmexPayeeNumber()).append(getAmexSeNumber())
                .append(getSeUnitNumber()).append(getPaymentYear()).append(getPaymentNumber())
                .append(getRecordType()).append(getDetailRecordType()).append(getSeBusinessDate())
                .append(getAmexProcessDate()).append(getSocInvoiceNumber()).append(getSocAmount())
                .append(getRocAmount()).append(getCardMemberNumber()).append(getCardMemberReferenceNumber())
                .append(getTransactionDate()).append(getInvoiceReferenceNumber())
                .append(getNonCompliantIndicator()).append(getNonCompliantErrorCode1())
                .append(getNonCompliantErrorCode2()).append(getNonCompliantErrorCode3())
                .append(getNonCompliantErrorCode4()).append(getNonSwipedIndicator())
                .append(getCardMemberNumberExtended()).toHashCode();
    }

    @Override
    public AmexRecordType getAmexRecordType() {
        return AmexRecordType.EPTRN_ROC_DETAIL;
    }
}
