...
@JsonPropertyOrder({ "AMEX_PAYEE_NUMBER", "AMEX_SE_NUMBER", "SE_UNIT_NUMBER", "PAYMENT_YEAR", "PAYMENT_NUMBER",
                     "RECORD_TYPE", "DETAIL_RECORD_TYPE", "AMEX_PROCESS_DATE", "ADJUSTMENT_NUMBER",
                     "ADJUSTMENT_AMOUNT", "DISCOUNT_AMOUNT", "SERVICE_FEE_AMOUNT", "NET_ADJUSTMENT_AMOUNT",
                     "DISCOUNT_RATE", "SERVICE_FEE_RATE", "CARDMEMBER_NUMBER", "ADJUSTMENT_REASON" })
public class AdjustmentDetail implements AmexFeedLineParserOutput {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(getAmexPayeeNumber(), that.getAmexPayeeNumber())
                ...
                .append(getAdjustmentReason(), that.getAdjustmentReason()).isEquals();
    }
    ...
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(getAmexPayeeNumber()).append(getAmexSeNumber())
                ...
                .append(getRecordType()).append(getDetailRecordType()).append(getAmexProcessDate())
                .append(getAdjustmentNumber()).append(getAdjustmentAmount()).append(getDiscountAmount())
                .append(getServiceFeeAmount()).append(getNetAdjustmentAmount()).append(getDiscountRate())
                .append(getServiceFeeRate()).append(getCardMemberNumber()).append(getAdjustmentReason())
                .toHashCode();
    }

    @Override
    public AmexRecordType getAmexRecordType() {
        return AmexRecordType.EPTRN_ADJUSTMENT_DETAIL;
    }
}
