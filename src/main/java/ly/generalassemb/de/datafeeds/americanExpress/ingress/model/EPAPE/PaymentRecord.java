...
public  class PaymentRecord {
    ...
    @JsonProperty("SETTLEMENT_SE_ACCOUNT_NUMBER")	@Size(max = 10)	@javax.validation.constraints.NotNull	private String settlementSeAccountNumber;
    @JsonProperty("SETTLEMENT_ACCOUNT_NAME_CODE")	@Size(max = 3)	@javax.validation.constraints.NotNull	private String settlementAccountNameCode;
    @JsonProperty("SETTLEMENT_DATE")	@Size(max = 8)	@javax.validation.constraints.NotNull	private Date settlementDate;


    @JsonProperty("RECORD_CODE")	@Size(max = 1)	@javax.validation.constraints.NotNull	private Integer recordCode;
    @JsonProperty("SOC_RECORD_CODE")	@Size(max = 2)	@javax.validation.constraints.NotNull	private String recordSubCode;

    @JsonProperty("SETTLEMENT_AMOUNT")	@Size(max = 15)	@javax.validation.constraints.NotNull	private BigDecimal settlementAmount;
    @JsonProperty("SE_BANK_SORT_CODE")	@Size(max = 15)	@javax.validation.constraints.NotNull	private String seBankSortCode;
    @JsonProperty("SE_BANK_ACCOUNT_NUMBER")	@Size(max = 20)	@javax.validation.constraints.NotNull	private String seBankAccountNumber;
    @JsonProperty("SETTLEMENT_GROSS_AMOUNT")	@Size(max = 15)	@javax.validation.constraints.NotNull	private BigDecimal settlementGrossAmount;
    @JsonProperty("TAX_AMOUNT")	@Size(max = 15)	@javax.validation.constraints.NotNull	private BigDecimal taxAmount;
    @JsonProperty("TAX_RATE")	@Size(max = 7)	@javax.validation.constraints.NotNull	private Integer taxRate;
    @JsonProperty("SERVICE_FEE_AMOUNT")	@Size(max = 15)	@javax.validation.constraints.NotNull	private BigDecimal serviceFeeAmount;

    @JsonProperty("SERVICE_FEE_RATE")	@Size(max = 7)	@javax.validation.constraints.NotNull	private Integer serviceFeeRate;

    @JsonProperty("SETTLEMENT_ADJUSTMENT_AMOUNT")	@Size(max = 15)	@javax.validation.constraints.NotNull	private BigDecimal settlementAdjustmentAmount;
    @JsonProperty("PAY_PLAN_SHORT_NAME")	@Size(max = 30)	@javax.validation.constraints.NotNull	private String payPlanShortName;
    @JsonProperty("PAYEE_NAME")	@Size(max = 38)	@javax.validation.constraints.NotNull	private String payeeName;
    @JsonProperty("SETTLEMENT_ACCOUNT_NAME_CODE_EXTENDED")	@Size(max = 20)	@javax.validation.constraints.NotNull	private String settlementAccountNameCodeExtended;
    @JsonProperty("SETTLEMENT_CURRENCY_CODE")	@Size(max = 3)	@javax.validation.constraints.NotNull	private String settlementCurrencyCode;
    @JsonProperty("PREVIOUS_DEBIT_BALANCE")	@Size(max = 15)	@javax.validation.constraints.NotNull	private BigDecimal previousDebitBalance;
    @JsonProperty("IBAN")	@Size(max = 34)	@javax.validation.constraints.NotNull	private String iban;
    @JsonProperty("BIC")	@Size(max = 12)	@javax.validation.constraints.NotNull	private String bic;
