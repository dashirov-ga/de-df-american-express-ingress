...
public class ROCDetail {
    ...
    public static void writeCSVFile(String csvFileName, List<ROCDetail> records) {
        ...
        CellProcessor[] processors = new CellProcessor[]{
                ...
                new Optional(new Trim()),
                new Optional(new Trim()),
                new Trim() // cardMemberNumberExtended
        ...
        try {
            ...
            String[] header = {"amexPayeeNumber", "amexSeNumber", "seUnitNumber", "paymentYear", "paymentNumber", "recordType", "detailRecordType",
                    "seBusinessDate", "amexProcessDate", "socInvoiceNumber", "socAmount", "rocAmount", "cardMemberNumber", "cardMemberReferenceNumber",
                    "transactionDate", "invoiceReferenceNumber", "nonCompliantIndicator", "nonCompliantErrorCode1", "nonCompliantErrorCode2", "nonCompliantErrorCode3", "nonCompliantErrorCode4", "nonSwipedIndicator", "cardMEmberNumberExtended"};
            beanWriter.writeHeader(header);

            for (ROCDetail record : records) {
