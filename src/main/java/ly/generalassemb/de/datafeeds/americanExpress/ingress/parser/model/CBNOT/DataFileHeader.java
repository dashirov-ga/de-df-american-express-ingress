...
@JsonPropertyOrder({ "dataFileHeaderRecordType", "amexApplication", "serviceAccessId", "dataType",
...
public class DataFileHeader implements AmexFeedLineParserOutput {
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(getDataFileHeaderRecordType()).append(getAmexApplication())
                .append(getServiceAccessId()).append(getDataType()).append(getOriginalFileTransmissionDateTime())
                .toHashCode();
    }

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonPropertyOrder({ "applicationSytemCode", "fileTypeCode", "fileCreationDate" })
    ...
    public AmexRecordType getAmexRecordType() {
        return AmexRecordType.CBNOT_HEADER;
    }
}
