...
@JsonPropertyOrder({ "AMEX_PAYEE_NUMBER", "AMEX_SE_NUMBER", "SE_UNIT_NUMBER", "PAYMENT_YEAR", "PAYMENT_NUMBER",
                     "RECORD_TYPE", "DETAIL_RECORD_TYPE", "SE_BUSINESS_DATE", "AMEX_PROCESS_DATE",
                     "SOC_INVOICE_NUMBER", "SOC_AMOUNT", "DISCOUNT_AMOUNT", "SERVICE_FEE_AMOUNT",
                     "NET_SOC_AMOUNT", "DISCOUNT_RATE", "SERVICE_FEE_RATE", "AMEX_GROSS_AMOUNT",
                     "AMEX_ROC_COUNT", "TRACKING_ID", "CPC_INDICATOR", "AMEX_ROC_COUNT_POA"

})
public class SOCDetail implements AmexFeedLineParserOutput {
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder().append(getAmexPayeeNumber(), socDetail.getAmexPayeeNumber())
                ...
                .append(getAmexROCCountPOA(), socDetail.getAmexROCCountPOA()).isEquals();
    }
    ...
    public int hashCode() {
        return new HashCodeBuilder(17, 37).append(getAmexPayeeNumber()).append(getAmexSeNumber())
                ...
                .append(getDiscountAmount()).append(getServiceFeeAmount()).append(getNetSOCAmount())
                .append(getDiscountRate()).append(getServiceFeeRate()).append(getAmexGrossAmount())
                .append(getAmexROCCount()).append(getTrackingId()).append(getCpcIndicator())
                .append(getAmexROCCountPOA()).toHashCode();
    }

    @Override
    public AmexRecordType getAmexRecordType() {
        return AmexRecordType.EPTRN_SOC_DETAIL;
    }
}
